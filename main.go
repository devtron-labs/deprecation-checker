...
func init() {
	...
	RootCmd.Flags().StringSliceVarP(&ignoreKeysFromValidation, "ignore-keys-for-validation", "", []string{"status*"}, "A comma-separated list of keys to be ignored for validation check")
